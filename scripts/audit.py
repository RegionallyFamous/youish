...
def main() -> int:
    ...
    case = Case(
        ...
        preserve_voice=clean_terms(args.voice),
        forbid=clean_terms(args.forbid),
        required_claims=clean_terms(args.required_claim),
        forbid_assertions=clean_terms(args.forbid_assertion),
